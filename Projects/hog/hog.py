...
def picky_piggy(score):
    ...
    """
    # BEGIN PROBLEM 2
    score_rolling_0_dice = 0
    if score % 6 == 1:
        score_rolling_0_dice = 1
    elif score % 6 == 2:
        score_rolling_0_dice = 4
    elif score % 6 == 3:
        score_rolling_0_dice = 2
    elif score % 6 == 4:
        score_rolling_0_dice = 8
    elif score % 6 == 5:
        score_rolling_0_dice = 5
    elif score % 6 == 0:
        score_rolling_0_dice = 7
    else:
        print ("Error!")
    return score_rolling_0_dice
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided, goal=GOAL_SCORE):
    ...
    # BEGIN PROBLEM 3
    if num_rolls == 0:
        sum = picky_piggy (opponent_score)
        return sum
    else:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    m, n = 1, 1
    score_before = 0 # define the max score
    while n <= 10:
        ...
        if score > score_before:
            ...
            m = m
        #print ("Roll", n, "dice(s)'s average mark is:", score)
        n += 1
    return m
    # END PROBLEM 9
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if picky_piggy_strategy (score, opponent_score, cutoff, num_rolls) == 0:
        return 0
    elif picky_piggy (opponent_score) == opponent_score - score:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    cutoff, num_rolls = 8, 6
    if picky_piggy (opponent_score) == opponent_score - score and opponent_score > cutoff:
        return 0
    elif GOAL_SCORE - score < 3:
        return 1
    elif GOAL_SCORE - score < 5:
        return 2
    elif GOAL_SCORE - score < 7:
        return 3
    else:
        return num_rolls
    # END PROBLEM 12
