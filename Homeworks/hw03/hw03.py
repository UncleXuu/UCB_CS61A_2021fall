...
def pingpong(n):
    ...
    True
    """
    def pingpong_helper(n, num, time = 1):
        if num > n:
            return 0
        elif num_eights(num) != 0 or num % 8 == 0:
            if time % 2 == 1:
                return pingpong_helper(n, num+1, time+1) + 1
            else:
                return pingpong_helper(n, num+1, time+1) - 1
        else:
            if time % 2 == 1:
                return pingpong_helper(n, num+1, time) + 1
            else:
                return pingpong_helper(n, num+1, time) - 1
...
def count_coins(change):
    ...
    True
    """
    def count_coins_helper(change, m):
        if change == 0:
            return 1
        elif change < 0:
            return 0
            ...
            return count_coins_helper(change-m, m) + count_coins_helper(change, descending_coin(m))
